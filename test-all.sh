...
cd ~/projects/jarvis-dashboard/athena
go build ./cmd/mnemo/ || { echo "FAIL: Go build"; exit 1; }
...
curl -sf http://100.71.66.54:8080/health > /dev/null && echo "  mnemo API: OK" || echo "  mnemo API: FAIL"
